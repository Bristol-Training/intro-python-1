...
In the previous section we saw how to repeat a set of instructions inside loops. But if you want to make use of that operation multiple times, you will have to copy and paste the code every time.

*Functions* provide a way of packaging code into reusable and easy-to-use components. We have seen plenty of examples of functions in this course, e.g. `print()` wraps up all the logic about exactly how to print things, all you need to do is pass in some arguments and it handles the rest.
