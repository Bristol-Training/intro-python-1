...
```{.python include="../scripts/dict1.py" filename="dict.py"}
```
...
```{.python include="../scripts/dict4.py" filename="dict.py"}
```
...
```{.python include="../scripts/dict7.py" filename="dict.py"}
```
...
```{.python include="../scripts/dict8.py" filename="dict.py"}
```
