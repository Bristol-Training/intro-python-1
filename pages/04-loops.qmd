...
```{.python include="../scripts/loops1.py" filename="loop.py"}
```
...
```{.python include="../scripts/loops2.py" filename="loop.py"}
```
...
```{.python include="../scripts/loops6.py" filename="loop.py"}
```
...
```{.python include="../scripts/loops10.py" filename="loop.py"}
```
...
```{.python include="../scripts/loops11.py" filename="loop.py"}
```
