...
Operators are essential for performing various operations on variables and values. You may want to multiply two numbers or compare them to know which one is greater, and operators allow us to do this.
...
It is easy to understand that the operator `==` returns `True` if two strings are the same. But what about `>` and `<`? 

Python doesn't understand the meaning of words "Tuesday" and "Wednesday", they are just two strings of characters. 

In the above examples:
str1 > str2 is asking python: “Is str1 alphabetically after str2?".  So in this example, does “Tuesday” come after “Wednesday” in the alphabet? (Answer: “No it doesn’t” so python returns “False”) 

str1 < str2 is asking python: “Is str1 alphabetically before str2”?.  So, does “Tuesday” come before “Wednesday” in the alphabet? (Answer: “Yes it does, so python returns “True”)
:::
