...
Moving to the lines above that, we can see printed the line of code at which the exception occurred along with the line number within the code (line 3). These are essential in larger work to track down where the problem came from.
